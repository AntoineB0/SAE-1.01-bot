...
if joueur[0] == "bot" or joueur[1] == "bot" :
    print("Vous jouez contre un bot !")

    while tour < 9:
        if tour % 2 == 0:
            if joueur[tour%2] == "bot" :
...
elif joueur[0] == "bot" and joueur[1] == "bot" :
    print("Vous regardez une partie entre deux bots")
